 ...
 */
public interface UserTagProducer {
     ...
     * @return
     */
    PageUtils<UserTagListVo> queryPage(UserTagListBo userTagListBo);
    ...
    */
     ...
     * @return
     */
     UserTagInfoVo save(UserTagBo userTagBo);
     ...
     * @return
     */
    void update(UserTagBo userTagBo);
