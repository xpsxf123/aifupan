...
public class UserLoginLogBo implements Serializable {
	...
	public UserLoginLogBo() {
	}

	public UserLoginLogBo(UserCacheVo vo, String loginIp, String remarks, Integer operaType, Integer operaStatus) {
		this.userId = vo.getId();
		this.userName = vo.getNickName();
		this.userType = vo.getUserType();
		this.ipAddress = loginIp;
