 ...
 */
@Data
@Schema(description = "Data Hub 成员登录状态查询请求")
public class DataHubLoginStatsQueryBo implements Serializable {
    ...
    @Schema(description = "用户ID列表（1~200 个）", requiredMode = Schema.RequiredMode.REQUIRED)
