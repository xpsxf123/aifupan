 ...
 */
public interface ClientInviteRewardRecordDetailProducer {
     ...
     * @return
     */
    PageUtils<ClientInviteRewardRecordDetailListVo> queryPage(ClientInviteRewardRecordDetailListBo clientInviteRewardRecordDetailListBo);
    ...
    * @return
    */
    ClientInviteRewardRecordDetailInfoVo info(Long id);
     ...
     * @return
     */
     ClientInviteRewardRecordDetailInfoVo save(ClientInviteRewardRecordDetailBo clientInviteRewardRecordDetailBo);
     ...
     * @return
     */
    void update(ClientInviteRewardRecordDetailBo clientInviteRewardRecordDetailBo);
