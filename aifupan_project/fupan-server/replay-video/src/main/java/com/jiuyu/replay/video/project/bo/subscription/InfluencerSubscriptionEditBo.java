 ...
 * @author RayChou
 * @date 2025-08-14
 * @description 编辑达人订阅信息的请求参数
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "编辑达人订阅业务对象")
public class InfluencerSubscriptionEditBo implements Serializable {
     ...
     * 分组ID
     */
    @Schema(description = "分组ID", example = "2")
    @Positive(message = "分组ID必须为正数")
