...
@NoArgsConstructor
@AllArgsConstructor
@TableName("tb_video_hot_search_snapshot")
@Schema(description = "爆款搜索快照表")
public class VideoHotSearchSnapshotEntity implements Serializable {
    ...
    @Schema(description = "搜索关键词", example = "美食")
    ...
    @Schema(description = "搜索到的视频总数", example = "100")
