...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "爆款示例视频列表查询业务对象")
public class VideoHotSearchListExampleQueryBo extends VideoPageBo implements Serializable {
    ...
    @Schema(description = "关键字", example = "减肥")
