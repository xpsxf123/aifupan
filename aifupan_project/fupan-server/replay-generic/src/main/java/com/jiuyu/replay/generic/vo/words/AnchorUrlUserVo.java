...
@Data
@Schema(description = "用户的主播信息")
public class AnchorUrlUserVo extends BasicSettingsBaseDto implements Serializable {
     ...
     * 从录制列表移除主播的时间
     */
    @Schema(description = "从录制列表移除主播的时间")
    ...
    private DiagnosisParams dataDiagnosisParams;
     ...
     * 话术质检开关 0否 1是
     */
    @Schema(description = "话术质检开关 0否 1是")
    private Integer isScriptQualityInspection;

    /**
     * 话术还原度开关 0否 1是
     */
    @Schema(description = "话术还原度开关 0否 1是")
    private Integer isScriptFidelityMonitor;

    /**
     * 互动巡检开关 0否 1是
     */
    @Schema(description = "互动巡检开关 0否 1是")
    private Integer isInteractionPatrol;

    /**
     * 当前已确认标准稿ID（B3 阶段就绪，当前恒为 null）
     */
    @Schema(description = "当前已确认标准稿ID（B3 阶段就绪，当前恒为 null）")
