 ...
 * @date 2025-08-28 17:21:00
 */
@Data
@TableName("tb_video_data_viewing_paragraph")
public class VideoDataViewingParagraphEntity implements Serializable {
	 ...
	 * 视频数据看板id
	 */
	private Long dataViewingConfuseId;
	/**
	 * 总观看人次
	 */
