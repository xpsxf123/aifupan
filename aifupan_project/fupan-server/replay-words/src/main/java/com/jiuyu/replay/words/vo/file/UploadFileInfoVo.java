...
import com.jiuyu.replay.words.vo.UploadFileAnalysisRecordVo;
...
public class UploadFileInfoVo {
    ...
    private UploadFileAnalysisRecordVo recordInfo;
    /**
     * 文件切片信息
     */
     ...
     * 切片视频所属原文件信息
     */
    @Schema(description = "切片视频所属原文件信息")
    private UploadFileInfoVo parentFileInfo;
    /**
     * 原文件下的所有切片信息
     */
    @Schema(description = "原文件下的所有切片信息")
