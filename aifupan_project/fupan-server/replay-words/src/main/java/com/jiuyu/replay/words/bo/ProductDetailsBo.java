...
public class ProductDetailsBo implements Serializable {
    ...
    @NotNull(message = "归属批次号不能为空", groups = {add.class})
    private String batchNumber;
    /**
     * 视频唯一标识
     */
    @Schema(description = "视频唯一标识")
    @NotNull(message = "视频唯一标识不能为空", groups = {add.class})
    ...
    @NotNull(message = "商品标题不能为空", groups = {add.class})
