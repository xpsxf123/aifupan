...
import ipConfig from './signatureConfig'
import FingerprintJS from '@fingerprintjs/fingerprintjs'

const {signatureConfig} = ipConfig
const _c = signatureConfig[import.meta.env.MODE].signature
...
function _getContentToSign(method, url, body, contentType) {
    ...
    if (method === 'GET') return _objectToQueryString(_parseQueryParams(url))
...
const apiSignature = {
    ...
    async createSignatureHeaders(body, method, url, contentType, signType = SIGN_TYPE.HMAC_SHA256) {
        ...
        const appId = signatureConfig[import.meta.env.MODE].appId
