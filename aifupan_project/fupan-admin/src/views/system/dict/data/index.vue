<template>
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm">
      <el-form-item>
        <el-select v-model="dataForm.typeId" clearable filterable placeholder="按字典类型筛选">
          <el-option v-for="item in typeList" :key="item.id" :label="item.name" :value="item.id">
          </el-option>
        </el-select>
      </el-form-item>
      <el-form-item>
        <el-input v-model="dataForm.keyword" clearable placeholder="输入关键字搜索"></el-input>
      </el-form-item>
      <el-form-item>
    ...
    <el-table v-loading="dataListLoading" :data="dataList" :element-loading-spinner="customSvg" border
      ...
      <el-table-column align="center" header-align="center" label="ID" prop="id" show-overflow-tooltip>
      </el-table-column>
      <el-table-column align="center" header-align="center" label="字典类型" min-width="100px" prop="typeName"
                       show-overflow-tooltip>
      </el-table-column>
      <el-table-column align="center" header-align="center" label="label" prop="label" show-overflow-tooltip>
      </el-table-column>
      <el-table-column align="center" header-align="center" label="value" prop="value">
      </el-table-column>
      ...
      <el-table-column align="center" header-align="center" label="创建时间" prop="createDate" show-overflow-tooltip
                       width="160px">
      </el-table-column>
      <el-table-column align="center" header-align="center" label="最后修改时间" prop="updateDate" show-overflow-tooltip
                       width="160px">
      </el-table-column>
...
import AddOrUpdate from './dictdata-add-or-update.vue'
...
const getDataList = () => {
  ...
  api.dictdata.list(dataForm).then((res) => {
    if (res && res.code === 0) {
