...
import com.jiuyu.governance.plugins.http.FuPanSignInterceptor;
...
public class RestReplayHttpServer implements ReplayHttpServer {

    private final RestClient restClient;


    public RestReplayHttpServer(RestClient.Builder clientBuilder, FupanServerProperties properties) {
        RestClient.Builder builder = clientBuilder.baseUrl(properties.getBaseUrl())
            .requestInterceptor(new FuPanSignInterceptor(properties.getClientId(), properties.getClientSecret()));
        ...
        this.restClient = builder.defaultHeader("x-jiuyu-client-id", properties.getAppId()).defaultHeader("api-key", properties.getAppSecret()).build();
    }
