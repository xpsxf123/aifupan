...
@Getter
@Setter
public class TeamPerformancePageRequest extends PageRequest implements DataPermissionsRequest {
    ...
    public List<String> dataTypes() {
        return List.of(OauthConstant.TEAM);
    }
    ...
    public List<Long> findDataIds(String dataType) {
        if (dataType.equals(OauthConstant.TEAM)) {
            return teamIds;
        }
        return null;
    }
