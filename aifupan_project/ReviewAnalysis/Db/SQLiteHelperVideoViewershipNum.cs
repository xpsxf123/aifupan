...
{
    public class SQLiteHelperVideoViewershipNum
    {
        ...
        public SQLiteHelperVideoViewershipNum()
        {
            _dbName = "review_analysis_total_online_num.db";
        ...
        public int Insert(string tableName, SQLiteParameter[] parameters)
        {
            ...
            int id = Convert.ToInt32(ExecuteScalar("SELECT MAX(id) FROM " + tableName));
            return id;
        }
