...
namespace ReviewAnalysis.Model
{
    public class OnlineNumNew
    {
        ...
        private readonly string tableName = "online_num_new";
        ...
        public int Save()
        {
            SQLiteHelperOnlineNumNew sQLiteHelper = new SQLiteHelperOnlineNumNew();
        ...
        /// </summary>
        /// <returns></returns>
        public List<OnlineNumNew> GetList()
        {
            SQLiteHelperOnlineNumNew sQLiteHelper = new SQLiteHelperOnlineNumNew();
            sQLiteHelper.GenerateSqlAndParameters(this, out string whereClause, out SQLiteParameter[] parameters);
            return sQLiteHelper.GetModelList<OnlineNumNew>(tableName, whereClause, parameters);
        }
