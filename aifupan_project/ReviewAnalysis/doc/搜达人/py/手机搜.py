...
def app_search(keyword):
    ...
    base_url = "https://aweme.snssdk.com/aweme/v1/search/item/"
    ...
    headers = {
        ...
        "sdk-version": "1",
        "X-Khronos": "1754133213",
        "X-Gorgon": "0401409c0001002f2599187a8da24d60cf21025bb85ea8d073b2"
    }
        ...
        if aweme_list:
            for aweme_info in aweme_list:
                ...
                item = {
                    ...
                    'create_time': convert_timestamp(aweme_info.get('create_time')),
                    ...
                    'video': {
                        ...
                        'play_url': jmespath.search('video.play_addr.url_list[0]', aweme_info),
                        'duration': int(
