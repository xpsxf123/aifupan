...
def search_video(keyword):
    headers = {
        ...
        "pragma": "no-cache",
        "priority": "u=1, i",
        "referer": f"https://trendinsight.oceanengine.com/arithmetic-index/videosearch?query={quote(keyword)}",
    ...
    cookies = {
        "sessionid_count": 'ee362944ff59baa7064cd8c1552c33c5'
    }
    url = "https://trendinsight.oceanengine.com/api/v2/index/itemQuery"
    # params = {
    #     "msToken": "qqM6M_oH2LFffBA3aqaIXNfa8H8zvbrH9UM-8TQI_HjXnIgr2UExDnK05RMRxNeCtSLCXwIZRaR_iLt_-0IXNFhg6v50rNfzlg3-7hVzU3fr_zShAT7cAw==",
    #     "X-Bogus": "DFSzswVLmDJI/HRYCrbY73YhjsEv",
    #     "_signature": "_02B4Z6wo00001lqC2mgAAIDBxOZ6-WZ5QYZagt7AAP48yD4MKt5RlilUJIWZHaZrvef4sm8qpPWEqPXpQ6EGuTdGUdv3Zeb7-ziRRv3hGvYPz6si66Auh4aACRygRwE27lJ137e-e.FOYhRF60"
    # }
    data = {
        "query": keyword,
        "authorIds": [],
    ...
    if len(response.text) > 1000:
        ...
        if json_data.get('status') == 0:
            for i in json_data['data']['data'][:150]:
                itemId = i.get('itemId')
                print(i) # 点赞和粉丝数不准
                # get_video_detail(itemId)
...
if __name__ == '__main__':
    ...
    for keyword in hot_search_keywords[:1]:
