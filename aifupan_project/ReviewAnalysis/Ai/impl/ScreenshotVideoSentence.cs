...
namespace ReviewAnalysis.Ai.impl
{
    ...
    /// 数据截图的数据来源-视频的数据截图
    /// </summary>
    public class ScreenshotVideoSentence : VideoSentence
    {
        public ScreenshotVideoSentence(string sourceId, List<long> videoTimeOneList) : base(sourceId, videoTimeOneList)
        {
