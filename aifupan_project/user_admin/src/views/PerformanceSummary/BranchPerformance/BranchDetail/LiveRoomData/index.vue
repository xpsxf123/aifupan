        ...
        <template #liveRoom="{ row }">
          <div class="info-cell">
            <div class="avtar-container">
              <el-avatar :size="30" :src="row.anchorAvatar || defaultImg" />
            </div>
...
<script setup>
  ...
  const emit = defineEmits(['view-live-room'])
  ...
  const tableColumns = [
    ...
    { label: '直播间', prop: 'name', minWidth: 200, slotName: 'liveRoom' },
